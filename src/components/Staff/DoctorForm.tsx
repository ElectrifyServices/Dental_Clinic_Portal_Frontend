    ...
    if (doctor) {
      if (singleStaffData) {
        ...
        form.reset({
          ...
          education: profile.education || profile.qualification || doctor.education || doctor.qualification || '',
          ...
          qualification: profile.qualification || profile.education || doctor.qualification || doctor.education || '',
