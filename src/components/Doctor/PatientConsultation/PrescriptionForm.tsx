            ...
            <div className="md:col-span-2">
              ...
              <div className="flex gap-1">
                <input
                  ...
                  min="1"
                  className="w-16 px-2 py-2 border border-green-200 rounded-lg focus:ring-2 focus:ring-green-500 bg-white text-center"
                  placeholder="5"
                />
                <select
                  value={prescription.durationUnit || 'Days'}
                  onChange={(e) => onUpdatePrescription(prescription.id, "durationUnit", e.target.value)}
                  className="flex-1 px-2 py-2 border border-green-200 rounded-lg focus:ring-2 focus:ring-green-500 bg-white text-sm"
                >
            ...
            <div className="md:col-span-1 flex items-center gap-2">
              <div className="flex-1">
                ...
                <input
                  ...
                  className="w-full px-2 py-2 border border-green-200 rounded-lg focus:ring-2 focus:ring-green-500 bg-white"
                  placeholder="10"
                />
              </div>
              {prescriptions.length > 1 && (
                <button
                  ...
                  className="p-2 mt-6 text-red-600 hover:bg-red-50 rounded-lg transition-all duration-200"
                >
