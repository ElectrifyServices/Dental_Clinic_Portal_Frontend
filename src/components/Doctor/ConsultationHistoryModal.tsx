...
//       <div className="bg-white w-[900px] max-h-[90vh] overflow-y-auto rounded-xl p-4">
...
//       <div>
//         <h3 className="font-bold">{item.patientName}</h3>
...
//       <p><b>Concern:</b> {item.observations}</p>
//       <p><b>Treatment:</b> {item.treatmentPlan}</p>
//     </div>
...
//         <div className="border p-2 rounded">{item.observations}</div>
//       </div>
//       <div>
//         <p className="text-sm font-semibold">Diagnosis</p>
//         <div className="border p-2 rounded">{item.diagnosis}</div>
//       </div>
//     </div>
...
//       <div className="border p-2 rounded">{item.treatmentPlan}</div>
//     </div>
...
//         <div key={p.id} className="text-sm border p-2 rounded mb-1">
//           <b>{p.medicine}</b> - {p.dosage} ({p.frequency}x/day) for {p.duration} days
//         </div>
//       ))}
//     </div>
// {/* Recommendations */}
...
// {/* Treatment Details */}
// {/* <div className="mb-3">
//   <p className="text-sm font-semibold">Treatment Details</p>
//   <div className="border p-2 rounded">
//     Procedure: {item.treatmentProcedure || "N/A"} <br />
//     Tooth: {item.treatmentTooth || "N/A"} <br />
//     Sessions: {item.treatmentSessions || 0}
//   </div>
// </div> */}
...
//       <div className="border p-2 rounded">
//         {item.consultationNotes || "No notes"}
//       </div>
//     </div>

//     {/* Cost */}
//     <div className="mb-3">
//       <p className="text-sm font-semibold">Treatment Cost</p>
//       <div className="border p-2 rounded">
//         ₹ {item.treatmentCost || 0}
//       </div>
//     </div>
...
//       <div className="border p-2 rounded">
//         {item.followUpRequired ? item.followUpDate : "Not required"}
//       </div>
//     </div>
