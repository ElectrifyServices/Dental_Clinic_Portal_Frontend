  ...
  return (
    <section>
      <div className="flex items-center gap-2 mb-4">
        ...
        <h4 className="text-[10px] font-bold text-foreground uppercase tracking-[0.2em]">Team Availability</h4>
          ...
          return (
            <div 
              ...
              className={`p-4 rounded-2xl border transition-all flex items-center justify-between ${
                available ? 'bg-card border-border' : 'bg-muted border-border opacity-75'
              }`}
            >
              <div className="flex items-center gap-3">
                <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-xs ${
                  available ? 'bg-primary text-white' : 'bg-muted text-muted-foreground'
                }`}>
