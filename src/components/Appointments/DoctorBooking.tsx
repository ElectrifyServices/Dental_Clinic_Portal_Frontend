                      ...
                      {cities.map((c) => (
                        ...
                        >
                          <Input
                            ...
                            onChange={() =>
                              toggleFilter(selectedCity, setSelectedCity, c)
                            }
        ...
        <div className="bg-card rounded-2xl border border-border shadow-2xl shadow-blue-500/5 flex flex-col overflow-hidden">
          {selectedDoctor ? (
                ...
                >
                  {nextDates.map((date, idx) => {
                    ...
                    return (
                      ...
                      >
                        <span
                          className={`text-[10px] font-bold uppercase ${isSelected ? "text-blue-100" : "text-muted-foreground/60"}`}
                        >
                          {dayName}
                        </span>
                        <span
                          className={`text-base font-bold ${isSelected ? "text-white" : "text-foreground"}`}
                        >
                          {dayNum}
                        </span>
                        {isToday && !isSelected && (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-[8px] font-bold text-primary/60 mt-0.5">
            ...
            <div className="flex-1 flex flex-col items-center justify-center py-40 px-10 text-center animate-in fade-in zoom-in duration-700">
              ...
              <p className="text-sm font-semibold text-muted-foreground/60 mt-4 max-w-xs">
                Pick a specialist from the left to access their real-time
                clinical calendar and schedule.
              </p>
            </div>
          )}
        </div>
