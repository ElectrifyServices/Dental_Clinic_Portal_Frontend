...
export function AppointmentList({ 
  ...
  const filtered = propAppointments.filter(a => {
    ...
    const searchMatch = name.includes(search.toLowerCase()) || (a.treatmentType || a.type || '').toLowerCase().includes(search.toLowerCase());
    if (filter === 'today') return searchMatch && new Date(a.date).toDateString() === today.toDateString();
    if (filter === 'week') {
