...
// export function InvoiceForm({ onClose, onSave, invoice ,  patients ,  appointments,
//   queuedPatients }: InvoiceFormProps) {
...
//   const lastConsultation = queuedPatients
//     ?.filter(q => q.patientName === selectedPatient.name)
//     ?.slice(-1)[0];

//   console.log("Selected:", selectedPatient);
//   console.log("Appointments:", lastAppointment);

//   if (lastAppointment) {
//     setFormData(prev => ({
//       ...prev,
//       doctor: doctors.find(d => d.includes(lastAppointment.doctorName)) || '',
//     }));

//     setItems([
//       {
//         id: Date.now().toString(),
//         description: lastAppointment.treatment || 'Consultation',
//         quantity: 1,
//         rate: lastAppointment.fee || 500,
//         amount: lastAppointment.fee || 500,
//       }
//     ]);
//   }
...
export function InvoiceForm({ onClose, onSave, invoice ,  patients  }: InvoiceFormProps) {
  const [formData, setFormData] = useState({
