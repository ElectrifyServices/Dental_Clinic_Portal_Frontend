    ...
    <div className={`grid grid-cols-12 gap-3 items-end p-3 rounded-xl border transition-all ${
        ...
        {isLinked ? (
          ...
          <div className="space-y-2">
            <select
              ...
              className="w-full px-3 py-2 bg-white border border-border rounded-lg text-sm font-medium focus:ring-2 focus:ring-primary/20 outline-none"
            >
            ...
            {(!commonServices.some(s => s.name === item.description) && !isLinked) && (
              <input
                ...
                className="w-full px-3 py-2 bg-white border border-border rounded-lg text-sm focus:ring-2 focus:ring-primary/20 outline-none"
              />
            )}
          </div>
        )}
      ...
      <div className="col-span-3 md:col-span-2">
        ...
        <input
          ...
          className="w-full px-3 py-2 bg-white border border-border rounded-lg text-sm text-center font-bold focus:ring-2 focus:ring-primary/20 outline-none"
        />
      </div>
      ...
      <div className="col-span-4 md:col-span-2">
        ...
        <input
          ...
          className={`w-full px-3 py-2 border rounded-lg text-sm font-bold text-right outline-none ${
            isLinked ? 'bg-indigo-100 border-indigo-200 text-indigo-900 cursor-not-allowed' : 'bg-white border-border focus:ring-2 focus:ring-primary/20'
          }`}
        />
      </div>
      ...
      <div className="col-span-4 md:col-span-2">
        ...
        <div className="w-full px-3 py-2 bg-muted/50 border border-border/50 rounded-lg text-sm font-black text-right text-gray-900">
