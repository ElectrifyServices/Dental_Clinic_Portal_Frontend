...
export function TreatmentForm({
  ...
  const handleChange = (
    ...
    form.setValue(name as keyof TreatmentFormData, value as any, {
      shouldValidate: true,
    });
    if (name === "patientName") {
    ...
    if (name === "procedure") {
      const template =
        treatmentTemplates[value as keyof typeof treatmentTemplates];
      if (template) {
  ...
  const handleLoadPlan = (plan: any) => {
    ...
    const template =
      treatmentTemplates[plan.procedure as keyof typeof treatmentTemplates];
    if (template) {
