              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <Button
                    ...
                    disabled={(sessions.length === 1 && session.isRequired) || isCompleted}
                  >
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      {(() => {
                        const defaultTimes = ["09:00", "09:30", "10:00", "10:30", "11:00", "11:30", "12:00", "12:30", "13:00", "13:30", "14:00", "14:30", "15:00", "15:30", "16:00", "16:30", "17:00"];
                        const currentVal = session.startTime || "09:00";
                        const times = [...defaultTimes];
                        if (currentVal && !times.includes(currentVal)) {
                          times.push(currentVal);
                        }
                        times.sort();
                        return times.map((t) => {
